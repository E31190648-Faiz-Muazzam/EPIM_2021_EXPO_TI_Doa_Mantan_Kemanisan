...
<div class="col-sm-8">
      <table class="table table-striped table-condensed">
        ...
        <?php 
          ...
          if ($rows['proses']=='0'){ $proses = '<i class="text-danger">Pending</i>'; $status = 'Proses'; }elseif($rows['proses']=='1'){ $proses = '<i class="text-success">Dikirim</i>'; }else{ $proses = '<i class="text-info">Konfirmasi</i>'; }
          echo "
                <tr class='success'>
