              ...
              <table class='table table-hover table-condensed'>
                ...
                <tbody>
                  <?php 
                    ...
                    if ($row['proses']=='0'){ $proses = '<i class="text-danger">Pending</i>'; $status = 'Proses'; $icon = 'star-empty'; $ubah = 1; }else{ $proses = '<i class="text-success">Dikirim</i>'; $status = 'Pending'; $icon = 'star text-yellow'; $ubah = 0; }
